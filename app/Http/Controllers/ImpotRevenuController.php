...
class ImpotRevenuController extends Controller
{
    ...
    public function calculer(Request $request)
    {
        ...
        // Barème progressif de l'impôt selon CGI Art. 123 (DGI Côte d'Ivoire)
        $bareme = [
            ['min' => 0, 'max' => 600000, 'taux' => 0],
            ['min' => 600001, 'max' => 1800000, 'taux' => 10],
            ['min' => 1800001, 'max' => 3000000, 'taux' => 15],
            ['min' => 3000001, 'max' => 7200000, 'taux' => 20],
            ['min' => 7200001, 'max' => 12000000, 'taux' => 25],
            ['min' => 12000001, 'max' => PHP_INT_MAX, 'taux' => 30],
        ];
    ...
    public function exportPDF(Request $request)
    {
        ...
        // Barème officiel DGI Côte d'Ivoire — CGI Art. 123
        $bareme = [
            ['min' => 0, 'max' => 600000, 'taux' => 0],
            ['min' => 600001, 'max' => 1800000, 'taux' => 10],
            ['min' => 1800001, 'max' => 3000000, 'taux' => 15],
        ...
        return view('comptabilite.impot-revenu-pdf', [
            ...
            'impot_brut' => $impot_brut,
            'impot_net' => $impot_net,
            'debut' => now()->startOfYear()->format('d/m/Y'),
            'fin' => now()->endOfYear()->format('d/m/Y'),
        ]);
    }
}
