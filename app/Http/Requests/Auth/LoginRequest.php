    ...
    public function authenticate(): void
    {
        ...
        if ($phoneColumn === null) {
            throw ValidationException::withMessages([
                'telephone' => 'Configuration incomplète: la colonne telephone/phone est absente de la table users.',
            ]);
        }
        ...
        if (!$user) {
               $user = \App\Models\User::where($phoneColumn, 'LIKE', '%' . $cleanPhone)->first();
        }
