...
class Fournisseur extends Model
{
    ...
    {
        return $this->hasMany(\App\Models\Vehicule::class, 'fournisseur_id');
    }

    public function missionsFournisseur()
    {
        return $this->hasMany(\App\Models\VehicleMission::class, 'supplier_id');
    }

    public function paiementsFournisseur()
    {
        return $this->hasMany(\App\Models\PaiementFournisseur::class, 'fournisseur_id');
    }
