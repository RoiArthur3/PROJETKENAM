    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div>
                    <a href="<?php echo e(route('comptabilite.factures.create')); ?>" class="btn btn-primary">
                        <i class="fas fa-plus me-2"></i>Nouvelle Facture
                    </a>
                    <a href="<?php echo e(route('comptabilite.index')); ?>" class="btn btn-outline-secondary ms-2">
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800" id="factures-clients">
                                <?php echo e($statsFactures['clients'] ?? 0); ?>
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800" id="factures-fournisseurs">
                                <?php echo e($statsFactures['fournisseurs'] ?? 0); ?>
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800" id="factures-en-attente">
                                <?php echo e($statsFactures['en_attente'] ?? 0); ?>
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800" id="factures-en-retard">
                                <?php echo e($statsFactures['en_retard'] ?? 0); ?>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered" id="facturesTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <a href="<?php echo e(route('comptabilite.factures.show', $facture->id)); ?>">
                                            <?php echo e($facture->numero); ?>

                                        </a>
                                    </td>
                                    <td><span class="badge bg-info"><?php echo e($facture->type ?? 'Client'); ?></span></td>
                                    <td><?php echo e($facture->client_nom ?? 'N/A'); ?></td>
                                    <td><?php echo e(\Carbon\Carbon::parse($facture->date_facture ?? now())->format('d/m/Y')); ?></td>
                                    <td class="text-end"><?php echo e(number_format($facture->montant_ht ?? 0, 0, ',', ' ')); ?></td>
                                    <td class="text-end"><?php echo e(number_format(($facture->montant_ht ?? 0) * (($facture->tva ?? 0) / 100), 0, ',', ' ')); ?></td>
                                    <td class="text-end"><?php echo e(number_format($facture->montant_ttc ?? 0, 0, ',', ' ')); ?></td>
                                    <td>
                                        ...
                                        <?php else: ?>
                                            <span class="badge bg-secondary"><?php echo e($facture->statut); ?></span>
                                        <?php endif; ?>
                                    </td>
                                    <td>
                                        <div class="btn-group">
                                            <a href="<?php echo e(route('comptabilite.factures.show', $facture->id)); ?>" class="btn btn-sm btn-outline-info">
                                                <i class="fas fa-eye"></i>
                                            </a>
                                            <a href="<?php echo e(route('comptabilite.factures.edit', $facture->id)); ?>" class="btn btn-sm btn-outline-primary">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <a href="<?php echo e(route('comptabilite.factures.print', $facture->id)); ?>" target="_blank" class="btn btn-sm btn-outline-secondary" title="Imprimer">
                                                <i class="fas fa-print"></i>
                                            </a>
                                            <?php if($facture->statut == 'en_attente' || $facture->statut == 'impayee'): ?>
                                                <button class="btn btn-sm btn-outline-success" onclick="markAsPaid(<?php echo e($facture->id); ?>)" title="Marquer comme payée">
                                                    <i class="fas fa-check"></i>
                                                </button>
                                            <?php endif; ?>
                                            <button class="btn btn-sm btn-outline-danger" onclick="deleteFacture(<?php echo e($facture->id); ?>)">
...
function loadStatistics() {
    $.get("<?php echo e(route('comptabilite.factures.statistics')); ?>", function(data) {
...
function deleteFacture(id) {
    if (confirm('Êtes-vous sûr de vouloir supprimer cette facture ?')) {
        ...
        form.action = '<?php echo e(route("comptabilite.factures.destroy", ":id")); ?>'.replace(':id', id);
        form.submit();
    }
}
...
function markAsPaid(id) {
    if (confirm('Êtes-vous sûr de vouloir marquer cette facture comme payée ?')) {
        ...
        form.action = '<?php echo e(route("comptabilite.factures.markPaid", ":id")); ?>'.replace(':id', id);
        form.submit();
    }
}
</script>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\kenam\resources\views/comptabilite/factures.blade.php ENDPATH**/ ?>