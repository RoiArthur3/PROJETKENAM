...
@section('title', "ANALYSE VARIATION DE LA TRESO - KENAM SERVICES")

@section('content')
<div class="content-wrapper">
    <div class="d-flex flex-wrap justify-content-between align-items-center gap-2 mb-4">
        <div>
            <h1 class="h3 mb-1">ANALYSE VARIATION DE LA TRESO</h1>
            <p class="text-muted mb-0">Comparatif N-1 / N des flux et soldes de tresorerie.</p>
        </div>
        <div class="d-flex gap-2">
            ...
            <a href="{{ route('comptabilite.rapports.analyse-variation-treso.export-excel', ['annee' => $donnees['annee_n']]) }}" class="btn btn-outline-success"><i class="fas fa-file-excel me-2"></i>Export Excel</a>
            <a href="{{ route('comptabilite.rapports.analyse-variation-treso.export-pdf', ['annee' => $donnees['annee_n']]) }}" class="btn btn-outline-danger"><i class="fas fa-file-pdf me-2"></i>Export PDF</a>
        </div>
    </div>

    <div class="card mb-4 shadow-sm">
        <div class="card-body">
            <form method="GET" action="{{ route('comptabilite.rapports.analyse-variation-treso') }}" class="row g-3 align-items-end">
                <div class="col-md-4">
                ...
                <div class="col-md-4 d-flex gap-2">
                    ...
                    <a href="{{ route('comptabilite.rapports.analyse-variation-treso') }}" class="btn btn-outline-secondary">Réinitialiser</a>
                </div>
            </form>
        </div>
    </div>
