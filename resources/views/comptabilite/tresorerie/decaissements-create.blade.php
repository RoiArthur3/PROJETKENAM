...
<div class="content-wrapper">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3 mb-0">Nouveau Décaissement</h1>
                    ...
                    <form method="POST" action="{{ route('tresorerie.decaissements.store') }}">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="reference" name="reference" required placeholder="DEC-2024-XXX">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="date_decaissement" class="form-label">Date de décaissement</label>
                                <input type="date" class="form-control" id="date_decaissement" name="date_decaissement" required value="{{ now()->format('Y-m-d') }}">
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <button type="submit" class="btn btn-primary">
                                    <i class="fas fa-save me-2"></i>Enregistrer le décaissement
                                </button>
                                <a href="{{ route('tresorerie.decaissements') }}" class="btn btn-outline-secondary">
