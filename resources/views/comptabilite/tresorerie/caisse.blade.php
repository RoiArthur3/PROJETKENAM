...
@section('title', 'Caisse - KENAM SERVICES')
...
<div class="content-wrapper">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div class="d-flex gap-2">
            ...
            <a href="{{ route('tresorerie.banque') }}" class="btn btn-outline-info">
                <i class="fas fa-university me-2"></i>Banque
            </a>
            <a href="{{ route('tresorerie.virements') }}" class="btn btn-outline-primary">
            ...
            <a href="{{ route('tresorerie.caisse.create') }}" class="btn btn-primary">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-2">
                    <button type="button" class="btn btn-outline-info" onclick="exportCaisse()">
                ...
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group">
                                    <a href="{{ route('tresorerie.caisse.show', $caisse->id) }}" class="btn btn-sm btn-outline-primary">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    <a href="{{ route('tresorerie.caisse.edit', $caisse->id) }}" class="btn btn-sm btn-outline-warning">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <form action="{{ route('tresorerie.caisse.destroy', $caisse->id) }}" method="POST" onsubmit="return confirm('Êtes-vous sûr de vouloir supprimer cette caisse ?')">
                                        @csrf
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('searchInput').addEventListener('input', filterCaisse);
    document.getElementById('statutFilter').addEventListener('change', filterCaisse);
    document.getElementById('responsableFilter').addEventListener('change', filterCaisse);
});
</script>
