...
@section('title', 'Nouvelle Avance - KENAM SERVICES')

@section('content')
<div class="content-wrapper">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3 mb-0">Nouvelle Avance</h1>
                    ...
                    <form method="POST" action="{{ route('tresorerie.avances.store') }}">
                        ...
                        <div class="row">
                            <div class="col-12 mb-3">
                                ...
                                <textarea class="form-control" id="description" name="description" rows="3" placeholder="Description détaillée de l'avance"></textarea>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
                                <button type="submit" class="btn btn-primary">
                                    <i class="fas fa-save me-2"></i>Créer l'avance
                                </button>
                                <a href="{{ route('tresorerie.avances') }}" class="btn btn-outline-secondary">
