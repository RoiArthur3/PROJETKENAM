@extends('layouts.app')
@section('title', 'Dashboard Comptabilité - KENAM SERVICES')
@section('content')
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $stats['total_ecritures'] ?? 0 }}</div>
                        </div>
                        <div class="col-auto">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $stats['total_factures'] ?? 0 }}</div>
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $stats['total_paiements'] ?? 0 }}</div>
                        </div>
                        <div class="col-auto">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{ number_format($stats['solde_tresorerie'] ?? 0, 0, ',', ' ') }} FCFA</div>
                        </div>
                        <div class="col-auto">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $stats['factures_impayees'] ?? 0 }}</div>
                            <div class="text-muted small">{{ number_format($stats['montant_impaye'] ?? 0, 0, ',', ' ') }} FCFA</div>
                            <div class="text-muted small">Retard: {{ $stats['factures_en_retard'] ?? 0 }}</div>
                        </div>
                        <div class="col-auto">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $stats['total_recettes'] ?? 0 }}</div>
                            <div class="text-muted small">{{ number_format($stats['montant_recettes'] ?? 0, 0, ',', ' ') }} FCFA</div>
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $stats['total_depenses'] ?? 0 }}</div>
                            <div class="text-muted small">{{ number_format($stats['montant_depenses'] ?? 0, 0, ',', ' ') }} FCFA</div>
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{ number_format($stats['solde_caisses'] ?? 0, 0, ',', ' ') }}</div>
    ...
    <div class="row">
        <div class="col-lg-6 mb-4">
            <div class="card shadow">
                ...
                <div class="card-body">
                    @if(isset($recentEcritures) && $recentEcritures->count() > 0)
                        <div class="table-responsive">
                            <table class="table table-sm">
                                ...
                                <tbody>
                                    @foreach($recentEcritures as $ecriture)
                                    <tr>
                                        <td>{{ \Carbon\Carbon::parse($ecriture->date_ecriture ?? now())->format('d/m/Y') }}</td>
                                        <td>{{ $ecriture->libelle ?? 'N/A' }}</td>
                                        <td>{{ number_format($ecriture->montant ?? 0, 0, ',', ' ') }} FCFA</td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
                            ...
                            <table class="table table-sm">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ number_format($invoice->montant ?? 0, 0, ',', ' ') }} FCFA</td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
