...
@section('title', 'Modifier Assurance | KENAM SERVICES')
        ...
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <h1 class="mb-0">
                    ...
                    Modifier Assurance #{{ $assurance->numero_police }}
                </h1>
    ...
    <div class="row">
        <div class="col-md-8">
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    <form action="{{ route('materiel.assurances.update', $assurance) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control @error('numero_police') is-invalid @enderror" 
                                    id="numero_police" name="numero_police" value="{{ old('numero_police', $assurance->numero_police) }}" required>
                                @error('numero_police')
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control @error('assureur') is-invalid @enderror" 
                                    id="assureur" name="assureur" value="{{ old('assureur', $assurance->assureur) }}" required>
                                @error('assureur')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-3">
                                ...
                                <select class="form-select @error('vehicule_id') is-invalid @enderror" 
                                    ...
                                    @foreach($vehicules as $vehicule)
                                        <option value="{{ $vehicule->id }}" 
                                            {{ old('vehicule_id', $assurance->vehicule_id) == $vehicule->id ? 'selected' : '' }}>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" step="0.01" class="form-control @error('prime_annuelle') is-invalid @enderror" 
                                    id="prime_annuelle" name="prime_annuelle" value="{{ old('prime_annuelle', $assurance->prime_annuelle) }}">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="date" class="form-control @error('date_debut') is-invalid @enderror" 
                                    id="date_debut" name="date_debut" value="{{ old('date_debut', $assurance->date_debut->format('Y-m-d')) }}" required>
                                @error('date_debut')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-md-6">
                                ...
                                <input type="date" class="form-control @error('date_fin') is-invalid @enderror" 
                                    id="date_fin" name="date_fin" value="{{ old('date_fin', $assurance->date_fin->format('Y-m-d')) }}" required>
                                @error('date_fin')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('notes') is-invalid @enderror" 
                                id="notes" name="notes" rows="3">{{ old('notes', $assurance->notes) }}</textarea>
                            @error('notes')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
