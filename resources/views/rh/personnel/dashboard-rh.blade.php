...
@section('title', 'Dashboard RH | KENAM SERVICES')
        ...
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <p class="text-muted mb-0">Suivi des indicateurs Ressources Humaines uniquement - {{ now()->format('d/m/Y') }}</p>
                </div>
                <div class="d-flex gap-2">
                    <a href="{{ url('/rh/personnel') }}" class="btn btn-outline-primary btn-sm">
        ...
        <div class="col-md-3">
            <div class="card shadow-sm border-start border-4 border-primary h-100">
                <div class="card-body">
                    ...
                    <div class="h3 mb-0 text-primary">{{ $rhStats['total'] ?? 0 }}</div>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-3">
            <div class="card shadow-sm border-start border-4 border-success h-100">
                <div class="card-body">
                    ...
                    <div class="h3 mb-0 text-success">{{ $rhStats['actifs'] ?? 0 }}</div>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-3">
            <div class="card shadow-sm border-start border-4 border-warning h-100">
                <div class="card-body">
                    ...
                    <div class="h3 mb-0 text-warning">{{ $rhStats['en_essai'] ?? 0 }}</div>
                    <small class="text-muted">Fin d'essai proche: {{ $rhStats['fin_essai_expiring'] ?? 0 }}</small>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-3">
            <div class="card shadow-sm border-start border-4 border-info h-100">
                <div class="card-body">
                    ...
                    <div class="h3 mb-0 text-info">{{ number_format($rhStats['salaire_moyen'] ?? 0, 0) }}</div>
        ...
        <div class="col-md-3">
            <div class="card shadow-sm border-start border-4 border-danger h-100">
                <div class="card-body">
                    ...
                    <div class="h3 mb-0 text-danger">{{ $rhStats['inactifs'] ?? 0 }}</div>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-3">
            <div class="card shadow-sm border-start border-4 border-secondary h-100">
                <div class="card-body">
                    ...
                    <div class="h3 mb-0 text-secondary">{{ $rhStats['realties'] ?? 0 }}</div>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-3">
            <div class="card shadow-sm border-start border-4 border-dark h-100">
                <div class="card-body">
                    ...
                    <div class="h3 mb-0 text-dark">{{ $rhStats['contrats_cdi'] ?? 0 }}</div>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-3">
            <div class="card shadow-sm border-start border-4 border-dark h-100">
                <div class="card-body">
                    ...
                    <div class="h3 mb-0 text-dark">{{ $rhStats['contrats_cdd'] ?? 0 }}</div>
                    <small class="text-muted">Expirant sous 30 jours: {{ $rhStats['contrats_expiring'] ?? 0 }}</small>
                </div>
            </div>
        </div>
    </div>
