...
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('rh.personnel.contrats.create') }}" class="btn btn-success btn-lg shadow-sm">
                    ...
                    <tbody>
                            ...
                            <td class="text-end pe-4">
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end shadow border-0 p-2">
                                        <li><a class="dropdown-item rounded-2" href="{{ route('rh.personnel.contrats.show', $contrat->id) }}">
                                            <i class="fas fa-eye me-2 text-info"></i>Détails
                                        </a></li>
                                        <li><a class="dropdown-item rounded-2" href="{{ route('rh.personnel.contrats.edit', $contrat->id) }}">
                        ...
                        <tr>
                            <td colspan="7" class="text-center py-5">
                                ...
                                <a href="{{ route('rh.personnel.contrats.create') }}" class="btn btn-success shadow-sm px-4">
