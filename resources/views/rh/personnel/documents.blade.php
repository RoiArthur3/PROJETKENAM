...
<div class="container-fluid mt-4">
    ...
    <div class="card mb-4">
        <div class="card-body">
            <form method="GET" action="{{ route('rh.personnel.documents', $personnel->id) }}" class="row g-3">
                <div class="col-md-4">
...
<div class="modal fade" id="uploadDocumentModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="POST" action="{{ route('rh.personnel.documents.store', $personnel->id) }}" enctype="multipart/form-data">
                @csrf
