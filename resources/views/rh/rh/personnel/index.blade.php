                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="d-flex gap-2">
                            <a href="{{ route('personnel.export') }}" class="btn btn-outline-success">
                                    ...
                                    <div class="btn-group" role="group">
                                        ...
                                        <div class="btn-group" role="group">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li>
                                                    <a class="dropdown-item" href="{{ route('personnel.conges', $personnel->id) }}">
                                                        <i class="fas fa-calendar-alt me-2"></i>Congés
                                                    </a>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item" href="{{ route('personnel.paies', $personnel->id) }}">
                                                        <i class="fas fa-money-bill me-2"></i>Paies
                                                    </a>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item" href="{{ route('personnel.documents', $personnel->id) }}">
                                                        <i class="fas fa-file me-2"></i>Documents
                                                    </a>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item" href="{{ route('personnel.fiche.pdf', $personnel->id) }}">
