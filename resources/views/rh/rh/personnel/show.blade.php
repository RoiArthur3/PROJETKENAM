...
<div class="container-fluid mt-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div class="d-flex gap-2">
            <a href="{{ route('personnel.contrats.create', ['personnel_id' => $personnel->id]) }}" class="btn btn-success">
                <i class="fas fa-file-contract me-1"></i>Nouveau Contrat
            </a>
            <a href="{{ route('personnel.fiche.pdf', $personnel->id) }}" class="btn btn-outline-danger">
            ...
            <div class="card sticky-top" style="top: 20px;">
                <div class="card-body text-center">
                    ...
                    <div class="d-grid gap-2">
                        <a href="{{ route('personnel.conges', $personnel->id) }}" class="btn btn-outline-primary btn-sm">
                            <i class="fas fa-calendar-alt me-1"></i>Gérer les congés
                        </a>
                        <a href="{{ route('personnel.paies', $personnel->id) }}" class="btn btn-outline-success btn-sm">
                            <i class="fas fa-money-bill me-1"></i>Historique paie
                        </a>
                        <a href="{{ route('personnel.documents', $personnel->id) }}" class="btn btn-outline-info btn-sm">
