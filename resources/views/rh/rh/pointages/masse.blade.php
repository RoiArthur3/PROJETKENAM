...
<x-dashboard-layout title="Pointages en Masse" icon="fas fa-users-clock">
    <x-slot name="kpis">
        <x-kpi-card title="Agents Actifs" value="{{ $agents->count() }}" icon="fas fa-user-check" color="success" />
        <x-kpi-card title="Date Sélectionnée" value="{{ date('d/m/Y') }}" icon="fas fa-calendar-day" color="primary" />
        <x-kpi-card title="Pointages à Traiter" value="{{ $agents->count() }}" icon="fas fa-clock" color="warning" />
                            ...
                            <div class="col-md-8">
                                <div class="d-flex align-items-end h-100">
                                    <div class="alert alert-info mb-0">
                                        ...
                                        <small>
                                            Sélectionnez la date puis remplissez les pointages pour tous les agents actifs.
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select class="form-select form-select-sm"
                                                    ...
                                                    id="statut_{{ $agent->id }}"
                                                    onchange="updateRowStyle({{ $agent->id }})">
                                        ...
                                        <td>
                                            <input type="text"
                                                   class="form-control form-control-sm"
                                                   name="pointages[{{ $agent->id }}][observations]"
                                    ...
                                    <div class="row text-center">
                                        ...
                                        <div class="col-3">
                                            <div class="text-secondary">
                                                ...
                                                <div class="fw-bold" id="countTotal">{{ $agents->count() }}</div>
                                                <small>Total</small>
                                            </div>
                                        </div>
                                    </div>
