                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-2 mb-3">
                            <a href="{{ route('personnel.create') }}" class="btn btn-primary w-100 h-100 d-flex flex-column align-items-center justify-content-center py-4 rounded-4 shadow-sm">
                        ...
                        <div class="col-md-2 mb-3">
                            <a href="{{ route('personnel.contrats.index') }}" class="btn btn-secondary w-100 h-100 d-flex flex-column align-items-center justify-content-center py-4 rounded-4 shadow-sm">
                                <i class="fas fa-file-contract fa-2x mb-2"></i>
                                <span class="fw-bold">Contrats RH</span>
                            </a>
                        </div>
                        <div class="col-md-2 mb-3">
                            <a href="{{ route('personnel.index') }}" class="btn btn-dark w-100 h-100 d-flex flex-column align-items-center justify-content-center py-4 rounded-4 shadow-sm">
