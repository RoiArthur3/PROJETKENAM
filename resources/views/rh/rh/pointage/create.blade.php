...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <div class="d-flex gap-2">
            <a href="{{ route('rh.pointage.index') }}" class="btn btn-outline-secondary">
                <i class="fas fa-list me-2"></i>Liste des Pointages
            </a>
            <a href="{{ route('rh.pointage.mass') }}" class="btn btn-outline-success">
    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
            <div class="card shadow">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('rh.pointage.store') }}" id="pointageForm">
                        @csrf
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <div>
                                <a href="{{ route('rh.pointage.index') }}" class="btn btn-secondary me-2">
