        ...
        <div class="col-lg-4">
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <a href="{{ route('rh.personnel.create') }}" class="btn btn-primary w-100 mb-2">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="btn-group btn-group-sm">
                                        <a href="{{ route('rh.personnel.show', $contrat->id) }}" class="btn btn-outline-primary" title="Voir">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <a href="{{ route('rh.personnel.edit', $contrat->id) }}" class="btn btn-outline-warning" title="Modifier">
                        ...
                        @empty
                            <tr>
                                <td colspan="9" class="text-center py-4">
                                    ...
                                    <a href="{{ route('rh.personnel.create') }}" class="btn btn-primary mt-2">
