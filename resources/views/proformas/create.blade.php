...
@section('title', 'Créer une Proforma')
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <form id="proforma-form" action="{{ route('proformas.store') }}" method="POST">
                    @csrf
                    <div class="card-body">
                        ...
                        <div class="row mb-4">
                            <div class="col-md-6">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="date" name="date_proposition" id="date_proposition" class="form-control" value="{{ date('Y-m-d') }}" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="date_validite" class="form-label">Date de validité <span class="text-danger">*</span></label>
                                            <input type="date" name="date_validite" id="date_validite" class="form-control" value="{{ date('Y-m-d', strtotime('+30 days')) }}" required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="conditions_generales" id="conditions_generales" class="form-control" rows="3" placeholder="Conditions générales de la proforma..."></textarea>
                                </div>

                                <div class="mb-3">
                                    <label for="note" class="form-label">Notes</label>
                                    <textarea name="note" id="note" class="form-control" rows="2" placeholder="Notes internes..."></textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <button type="button" id="add-item-btn" class="btn btn-outline-success btn-sm mb-3">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-6 text-end">
                                                <span id="total-ht">0,00 FCFA</span>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-6">
                                            ...
                                            <div class="col-6 text-end">
                                                <span id="total-tva">0,00 FCFA</span>
                                            </div>
                                        </div>
                                        <hr>
                                        <div class="row">
                                            ...
                                            <div class="col-6 text-end">
                                                <strong id="total-ttc">0,00 FCFA</strong>
                                            </div>
                                        </div>
                                        <div class="row mt-2">
                                            <div class="col-12">
                                                <small class="text-muted">Montant en lettres : <span id="montant-lettres">-</span></small>
                                            </div>
                                        </div>
                                    </div>
                                </div>
