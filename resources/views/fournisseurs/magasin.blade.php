...
@section('title', 'Fournisseurs Magasin - KENAM SERVICES')
            ...
            <div class="card">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            <a href="{{ route('fournisseurs.create') }}" class="btn btn-light btn-sm">
                                <i class="fas fa-plus"></i> Nouveau Fournisseur Magasin
                            </a>
                ...
                <div class="card-body">
                    <div class="alert alert-success">
                        ...
                        <strong>Fournisseurs pour le Magasin</strong><br>
                        Cette page affiche les fournisseurs spécialisés dans les produits et équipements pour le magasin.
                    </div>
                                    ...
                                    <tr>
                                        <td colspan="7" class="text-center">
                                            <div class="alert alert-warning">
                                                ...
                                                Aucun fournisseur magasin trouvé.
