...
@section('title', 'Validations Approuvées')
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h2>
                        <i class="fas fa-check-circle me-2"></i>Validations Approuvées
                    </h2>
                    <small class="text-muted">Opérations que vous avez approuvées</small>
                </div>
            ...
            <div class="card shadow">
                <div class="card-header bg-success text-white">
                    <h5 class="m-0">
                        <i class="fas fa-check me-2"></i>{{ count($operations) }} Opération(s) approuvée(s)
                    </h5>
                </div>
                <div class="card-body">
                    ...
                    @else
                        <div class="text-center py-5">
                            ...
                            <p class="text-muted">
                                <strong>Vous n'avez approuvé aucune opération</strong><br>
                                Les opérations que vous approuverez apparaîtront ici.
                            </p>
            ...
            <div class="mt-4">
                <div class="nav nav-tabs" role="tablist">
                    ...
                    <a href="{{ route('validations.approved') }}" class="nav-link active">
