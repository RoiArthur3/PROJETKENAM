...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Créer un nouveau workflow') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="#">
                        ...
                        <div class="form-group row mb-3">
                            <label for="name" class="col-md-4 col-form-label text-md-end">{{ __('Nom du workflow') }}</label>
