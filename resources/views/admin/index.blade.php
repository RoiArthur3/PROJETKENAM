                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                @if($user->role)
                                    <span class="badge bg-{{ $user->role === 'superadmin' ? 'danger' : ($user->role === 'admin' ? 'warning' : ($user->role === 'moderator' ? 'info' : 'secondary')) }}">
                            ...
                            <td>
                                <div class="btn-group btn-group-sm">
                                    ...
                                    @if($user->role === 'moderator' || $user->role === 'moderateur')
                                        <a href="{{ route('admin.comptes.users.submodules.edit', $user) }}" class="btn btn-outline-info" title="Permissions détaillées">
                                            <i class="fas fa-user-shield"></i>
                                        </a>
                                    @endif
