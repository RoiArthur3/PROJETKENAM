                                ...
                                <table class="table table-striped table-hover">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group btn-group-sm" role="group">
                                                    <button class="btn btn-outline-success" title="Voir" onclick="alert('Aperçu du rapport : Rapport_inventaire_Q4_2025.pdf')">
                                                        <i class="fas fa-eye"></i>
                                                    </button>
                                                    <button class="btn btn-outline-warning" title="Éditer" onclick="alert('Édition du rapport : Rapport_inventaire_Q4_2025.pdf')">
                                                        <i class="fas fa-edit"></i>
                                                    </button>
                                                    <button class="btn btn-outline-danger" title="Supprimer" onclick="if(confirm('Supprimer ce rapport ?')){ alert('Rapport supprimé !'); }">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group btn-group-sm" role="group">
                                                    <button class="btn btn-outline-success" title="Voir" onclick="alert('Aperçu du rapport : Mouvements_stock_Décembre_2025.xlsx')">
                                                        <i class="fas fa-eye"></i>
                                                    </button>
                                                    <button class="btn btn-outline-warning" title="Éditer" onclick="alert('Édition du rapport : Mouvements_stock_Décembre_2025.xlsx')">
                                                        <i class="fas fa-edit"></i>
                                                    </button>
                                                    <button class="btn btn-outline-danger" title="Supprimer" onclick="if(confirm('Supprimer ce rapport ?')){ alert('Rapport supprimé !'); }">
                                                        <i class="fas fa-trash"></i>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group btn-group-sm" role="group">
                                                    <button class="btn btn-outline-success" title="Voir" onclick="alert('Aperçu du rapport : Produits_rupture_Janvier_2026.pdf')">
                                                        <i class="fas fa-eye"></i>
                                                    </button>
                                                    <button class="btn btn-outline-warning" title="Éditer" onclick="alert('Édition du rapport : Produits_rupture_Janvier_2026.pdf')">
                                                        <i class="fas fa-edit"></i>
                                                    </button>
                                                    <button class="btn btn-outline-danger" title="Supprimer" onclick="if(confirm('Supprimer ce rapport ?')){ alert('Rapport supprimé !'); }">
                                                        <i class="fas fa-trash"></i>
