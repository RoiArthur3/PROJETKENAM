...
class DashboardController extends Controller
{
    public function index()
    {
        ...
        $depensesMensuelles = \App\Models\DepenseCaisse::whereMonth('date_depense', now()->month)
            ->whereYear('date_depense', now()->year)
            ->sum('montant');

        $approvisionnementsRecents = \App\Models\ApprovisionnementCaisse::with(['demandeur'])
            ->latest()
            ->limit(5)
            ->get();

        $depensesRecentes = \App\Models\DepenseCaisse::with(['caisse', 'createur'])
            ->latest()
            ->limit(5)
            ->get();
        ...
        $stats = [
            ...
            'total_decaissements' => \App\Models\DepenseCaisse::count(),
        ...
        $decaissements = $depensesRecentes;
    ...
    {
        $decaissements = \App\Models\DepenseCaisse::with(['caisse', 'createur'])->latest()->get();
    ...
    {
        $flux = \App\Models\MouvementCaisse::with(['caisse'])->latest()->get();
