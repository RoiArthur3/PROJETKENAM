                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <div class="text-muted small">
                                            @if($recette->encaissement_id)
                                                <a href="{{ route('tresorerie.encaissements.show', $recette->encaissement_id) }}" class="badge bg-soft-info text-info text-decoration-none">
                                                    <i class="fas fa-wallet me-1"></i>Trésorerie
                                                </a>
                                            @elseif($recette->payment_id)
                                                <a href="{{ route('comptabilite.paiements.show', $recette->payment_id) }}" class="badge bg-soft-primary text-primary text-decoration-none">
                                                    <i class="fas fa-file-invoice me-1"></i>Paiement Facture
                                                </a>
                                            @else
                                                <span class="badge bg-soft-secondary text-secondary">Manuel</span>
                                            @endif
                                        </div>
                                    </div>
                                </div>
