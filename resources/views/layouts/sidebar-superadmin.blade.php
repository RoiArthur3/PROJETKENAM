...
<div id="app-sidebar" class="sidebar-desktop">
    ...
    <div class="sidebar-header">
        <a href="{{ auth()->user()->role === 'superadmin' ? '/dashboard' : (auth()->user()->getFirstAccessibleModuleUrl() ?? '/operations') }}">
    ...
    <div class="sidebar-menu">
        ...
        <div class="floating-submenu" id="submenu-direction_generale">
            ...
            <a href="{{ route('juridique.dashboard') }}" class="submenu-link"><i class="fas fa-gavel text-warning"></i><span>Juridique</span></a>
            @endif
            <a href="{{ route('hikvision.live') }}" class="submenu-link">
                <i class="fas fa-video text-primary"></i>
                <span>Surveillance en direct</span>
            </a>
            <a href="{{ route('validations.history') }}" class="submenu-link"><i class="fas fa-history text-secondary"></i><span>Suivi global</span></a>
            @if(Route::has('validations.to-pay'))
            <a href="{{ route('validations.to-pay') }}" class="submenu-link"><i class="fas fa-stamp text-danger"></i><span>BON POUR ACCORD</span></a>
            @endif
        </div>
        ...
        <div class="floating-submenu" id="submenu-validations">
            ...
            @endphp
            @foreach($validationLinks as $vLink)
                @php
                ...
                @endphp
                @if($canSee && $hasRoute)
                <a href="{{ $href }}" class="submenu-link"><i class="{{ $vLink['icon'] }}"></i><span>{{ $vLink['label'] }}</span></a>
                @endif
            @endforeach
        </div>
        ...
        <div class="floating-submenu" id="submenu-comptabilite">
            <a href="{{ route('comptabilite.dashboard') }}" class="submenu-link"><i class="fas fa-tachometer-alt text-primary"></i><span>Dashboard</span></a>
            <a href="{{ route('comptabilite.factures.index') }}" class="submenu-link"><i class="fas fa-file-invoice text-info"></i><span>Factures</span></a>
            <a href="{{ route('comptabilite.depenses.index') }}" class="submenu-link"><i class="fas fa-money-bill-wave text-danger"></i><span>Dépenses</span></a>
            <a href="{{ route('comptabilite.recettes.index') }}" class="submenu-link"><i class="fas fa-hand-holding-usd text-success"></i><span>Recettes</span></a>
            <a href="{{ route('comptabilite.rapports.grand-journal') }}" class="submenu-link"><i class="fas fa-book-open text-info"></i><span>Grand Journal</span></a>
            <a href="{{ route('comptabilite.rapports.bilan') }}" class="submenu-link"><i class="fas fa-balance-scale text-secondary"></i><span>Bilan</span></a>
            <a href="{{ route('comptabilite.rapports.compte-resultat') }}" class="submenu-link"><i class="fas fa-chart-line text-warning"></i><span>Compte Résultat</span></a>
            <a href="{{ route('comptabilite.rapports.analyse-activite') }}" class="submenu-link"><i class="fas fa-table text-dark"></i><span>ANALYSE DE L'ACTIVITE</span></a>
            <a href="{{ route('comptabilite.rapports.analyse-rentabilite') }}" class="submenu-link"><i class="fas fa-percentage text-primary"></i><span>ANALYSE DE RENTABILITE</span></a>
            <a href="{{ route('comptabilite.rapports.analyse-variation-treso') }}" class="submenu-link"><i class="fas fa-water text-info"></i><span>ANALYSE VARIATION DE LA TRESO</span></a>
            <a href="{{ route('comptabilite.rapports.analyse-variation-dette') }}" class="submenu-link"><i class="fas fa-file-invoice-dollar text-danger"></i><span>ANALYSE VARIATION DE LA DETTE</span></a>
            <a href="{{ route('comptabilite.approvisionnement-demandes.pending') }}" class="submenu-link"><i class="fas fa-clipboard-check text-warning"></i><span>Demandes d'approvisionnement</span></a>
        </div>
        ...
        <div class="floating-submenu" id="submenu-tresorerie">
            ...
            @foreach($tresorerieSubmodules as $key => $submodule)
                @if(in_array($key, ['tres_dashboard', 'tres_caisses', 'tres_appro', 'tres_appro_dem', 'tres_bon_accord', 'tres_encaisse', 'tres_decaisse', 'tres_rapproche', 'tres_a_payer', 'tres_soldes']))
                    <a href="{{ route($submodule['route']) }}" class="submenu-link"><i class="{{ $submodule['icon'] }} text-info"></i><span>{{ $submodule['name'] }}</span></a>
                @endif
            @endforeach
            <a href="{{ route('tresorerie.banque') }}" class="submenu-link"><i class="fas fa-university text-info"></i><span>Banque</span></a>
            <a href="{{ route('tresorerie.avances') }}" class="submenu-link"><i class="fas fa-hand-holding-usd text-info"></i><span>Acomptes</span></a>
        </div>
        ...
        <div class="floating-submenu" id="submenu-commercial">
            @if(Route::has('commercial.dashboard'))
            <a href="{{ route('commercial.dashboard') }}" class="submenu-link"><i class="fas fa-tachometer-alt text-primary"></i><span>Dashboard Commercial</span></a>
            @else
            ...
            @endif
            @if(Route::has('commercial.clients.index'))
            <a href="{{ route('commercial.clients.index') }}" class="submenu-link"><i class="fas fa-users text-info"></i><span>Clients</span></a>
            @endif
            @if(Route::has('commercial.prospects.index'))
            <a href="{{ route('commercial.prospects.index') }}" class="submenu-link"><i class="fas fa-user-plus text-success"></i><span>Prospects</span></a>
            @else
            <a href="/commercial/prospects" class="submenu-link"><i class="fas fa-user-plus text-success"></i><span>Prospects</span></a>
            @endif
            @if(Route::has('commercial.commandes.index'))
            <a href="{{ route('commercial.commandes.index') }}" class="submenu-link"><i class="fas fa-clipboard-list text-warning"></i><span>Commandes</span></a>
            @endif
            @if(Route::has('commercial.bon-commande.index'))
            <a href="{{ route('commercial.bon-commande.index') }}" class="submenu-link"><i class="fas fa-file-signature text-secondary"></i><span>Bons de commande</span></a>
            @endif
            @if(Route::has('commercial.bon-livraison.index'))
            <a href="{{ route('commercial.bon-livraison.index') }}" class="submenu-link"><i class="fas fa-truck text-success"></i><span>Bons de livraison</span></a>
            @endif
            @if(Route::has('commercial.devis.index'))
            <a href="{{ route('commercial.devis.index') }}" class="submenu-link"><i class="fas fa-file-invoice text-danger"></i><span>Devis</span></a>
            @endif
        </div>
        @endif

        @if(auth()->user()->canAccessModule('achat'))
        ...
        <div class="floating-submenu large-grid" id="submenu-logistique">
            ...
            <a href="{{ route('materiel.missions.index') }}" class="submenu-link"><i class="fas fa-map-location-dot text-danger"></i><span>Liste des missions</span></a>
        ...
        <div class="floating-submenu" id="submenu-rh">
            ...
            <a href="{{ route('rh.personnel.index') }}" class="submenu-link"><i class="fas fa-users text-info"></i><span>Personnel</span></a>
            <a href="{{ route('rh.paie.index') }}" class="submenu-link"><i class="fas fa-money-bill text-success"></i><span>Paie</span></a>
        ...
        <div class="floating-submenu" id="submenu-administration">
            ...
            <a href="{{ route('settings.index') }}" class="submenu-link"><i class="fas fa-cog text-primary"></i><span>Paramètres</span></a>
            @endif
            @if(Route::has('parametrage.index'))
            <a href="{{ route('parametrage.index') }}" class="submenu-link"><i class="fas fa-sliders-h text-info"></i><span>Paramétrage</span></a>
            @endif
            @if(Route::has('imports.historique.index'))
            <a href="{{ route('imports.historique.index') }}" class="submenu-link"><i class="fas fa-file-import text-success"></i><span>Import Historique</span></a>
            @endif
            @if(Route::has('admin.permissions'))
            <a href="{{ route('admin.permissions') }}" class="submenu-link"><i class="fas fa-key text-warning"></i><span>Permissions</span></a>
            @endif
            @if(Route::has('admin.comptes.users.index'))
            <a href="{{ route('admin.comptes.users.index') }}" class="submenu-link"><i class="fas fa-users-cog text-success"></i><span>Utilisateurs</span></a>
            @endif
        </div>
