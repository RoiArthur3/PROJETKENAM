...
<body>
    ...
    <div class="email-footer">
        ...
        <div class="contact-info">
            @if($entrepriseSettings && $entrepriseSettings->email_contact)
                <a href="mailto:{{ $entrepriseSettings->email_contact }}" class="contact-item">
                    <i class="fas fa-envelope"></i>
                    {{ $entrepriseSettings->email_contact }}
                </a>
            @else
                <a href="mailto:contact@kenamservices.net" class="contact-item">
                    <i class="fas fa-envelope"></i>
                    contact@kenamservices.net
                </a>
            @endif

            @if($entrepriseSettings && $entrepriseSettings->telephone)
                <a href="tel:{{ $entrepriseSettings->telephone }}" class="contact-item">
                    <i class="fas fa-phone"></i>
                    {{ $entrepriseSettings->telephone }}
                </a>
            @else
                <a href="tel:+22890000000" class="contact-item">
                    <i class="fas fa-phone"></i>
                    +228 90 00 00 00
                </a>
            @endif

            @if($entrepriseSettings && $entrepriseSettings->site_web)
                <a href="{{ $entrepriseSettings->site_web }}" class="contact-item">
                    <i class="fas fa-globe"></i>
                    {{ parse_url($entrepriseSettings->site_web, PHP_URL_HOST) ?? $entrepriseSettings->site_web }}
                </a>
            @else
                <a href="https://kenamservices.net" class="contact-item">
                    <i class="fas fa-globe"></i>
                    www.kenamservices.net
                </a>
            @endif
        </div>
