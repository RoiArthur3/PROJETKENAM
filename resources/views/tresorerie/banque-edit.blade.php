...
<div class="content-wrapper">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3 mb-0">Modifier l'Opération Bancaire</h1>
    ...
    <div class="row">
        <div class="col-md-8 mx-auto">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form action="{{ route('tresorerie.banque.update', $operation->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <select name="caisse_id" id="caisse_id" class="form-select @error('caisse_id') is-invalid @enderror" required>
                                    @foreach($caisses as $caisse)
                                        <option value="{{ $caisse->id }}" {{ $operation->caisse_id == $caisse->id ? 'selected' : '' }}>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="datetime-local" name="date_mouvement" id="date_mouvement" 
                                       ...
                                       value="{{ \Carbon\Carbon::parse($operation->date_mouvement)->format('Y-m-d\TH:i') }}" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="libelle" id="libelle" 
                                   ...
                                   value="{{ old('libelle', $operation->libelle) }}" placeholder="Ex: Virement reçu client X" required>
                            @error('libelle')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <select name="type_mouvement" id="type_mouvement" class="form-select @error('type_mouvement') is-invalid @enderror" required>
                                    <option value="entree" {{ $operation->type_mouvement == 'entree' ? 'selected' : '' }}>ENTRÉE (CRÉDIT)</option>
                                    <option value="sortie" {{ $operation->type_mouvement == 'sortie' ? 'selected' : '' }}>SORTIE (DÉBIT)</option>
                                </select>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    <input type="number" name="montant" id="montant" 
                                           ...
                                           value="{{ old('montant', $operation->montant) }}" min="0" required>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="description" id="description" rows="4" 
                                      ...
                                      placeholder="Informations complémentaires...">{{ old('description', $operation->description) }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
