...
// Récupérer la configuration depuis les paramètres
$config = [
    ...
    'user' => config('hikvision.default_user', 'admin'),
    'password' => config('hikvision.default_password', 'Arthur@752'),
    'timeout' => config('hikvision.default_timeout', 30)
];
